...
(function($) {  
  // 插件的定义  
  $.fn.leaveByTeacherInit = function() {
	  var $this = $(this);
	  var id = $(this).attr('id');
	...
	var search = function(flag){
		...
		var content = {'student.studentId':studentId,page:pageNumber,rows:pageSize};
		//取得列表信息
		var url = 'teacher/queryByTeacherLeave.do';
	...
	var getTotal = function(content){
		var url = "teacher/getTotalCountByTeacherLeave.do";
	...
	//删除
		var onDelete = function(){
			...
			$.messager.confirm('确认', '确定删除该记录吗?', function(r){
				if(r){
					var url = "teacher/deleteLeave.do";
